...
/** This module, caching-geocoder, geo-codes location names: it maps
  ...
  * during app initiation i.e. provide a primed cache.
  *  
...
function promiseLocCoords(aName){
  ...
  // Could add a null then() here to start if off but probably not needed.


/*

        .then(function(aResp){
//THIS CHUNK HERE is the DCer
...
// Yet Promise.promisify can be more efficient and SuperAgent has a more elegant
